...
int main() {
    ...
    if (b1.score > b2.score && b1.score > b3.score) {
        printf("\n\nThe highest scores belongs to : %s at %.2f scores", b1.name, b1.score);
    } else if (b2.score > b1.score && b2.score > b3.score) {
        printf("\n\nThe highest scores belongs to : %s at %.2f scores", b2.name, b2.score);
    } else {
        printf("\n\nThe highest scores belongs to : %s at %.2f scores", b3.name, b3.score);
    }
    return 0;
}